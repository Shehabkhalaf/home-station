                                ...
                                <div class="buttons d-flex justify-content-start align-items-center">
                                    <button type="button"  id="btn-details" data-id="${product.id}" class="btn btn-primary buttonStyle me-3"
                                        data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">
                                                                                        <span class="me-1">EGP</span>    ${product.discount[0]}
                                    </button>
                                    <button type="button" id="addCard" data-id="${product.id}" class="btn  btn-primary buttonStyle"><i class="fa-solid fa-cart-plus"></i>Add to
                                                            Card 
                                    </button>
                                </div>
                            </div>
